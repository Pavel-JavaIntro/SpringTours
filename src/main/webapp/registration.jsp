...
<form method="post" action="users">
    <label for="name">Enter your name </label><input type="text" id="name" name="name" placeholder="Имя"/><br/>
    ...
    <label for="password1">Enter your password </label><input type="password" id="password1" name="password" placeholder="Password"/><br/>
...
<%--<form:form method="post" action="users"><br>--%>
...
<%--    Enter password again: <form:input type="text" path="password"/><br>--%>
